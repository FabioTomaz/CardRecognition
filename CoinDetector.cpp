...
int main(int argc, char** argv)
{
	...
	HoughCircles(contourImg2, circles, CV_HOUGH_GRADIENT, 2, gray.rows / 8, 175, 45, 30, 100);
	...
	for (size_t i = 0; i < circles.size(); i++)
	{
		...
		rectangle(imgScaled, Point(center.x - radius - 5, center.y - radius - 5), Point(center.x + radius + 5, center.y + radius + 5), CV_RGB(0, 0, 255), 1, 8, 0); //Opened contour - draw a green rectangle arpund circle
